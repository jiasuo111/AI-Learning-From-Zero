...
![img](https://i-blog.csdnimg.cn/direct/5bd97028cf4346289d6dbdea4156406c.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/ebcc1456497e44048b20583c34158f5c.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/12144cc0e5b44bb08e971a35e8a34d02.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑



## 【实操】基于window中ollama部署私有大模型

### 安装ollama



![img](https://i-blog.csdnimg.cn/direct/69f2ad58b3a240b78187a0b64d33909a.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

### 部署大模型

![img](https://i-blog.csdnimg.cn/direct/5f1169abb2e6482888b131dac9de7601.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

### 安装位置

![img](https://i-blog.csdnimg.cn/direct/90124f712a4845f4b8ce90db5d55f76c.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

### 部署大模型

'![img](https://i-blog.csdnimg.cn/direct/5d4af57f8cbb4226829d6641d7f50810.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

![img](https://i-blog.csdnimg.cn/direct/90466ca7e05047b4b99b85a2233453d4.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑'
...
![img](https://i-blog.csdnimg.cn/direct/3c9c10a75d8b40ce8eb86f0f871c5253.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

![img](https://i-blog.csdnimg.cn/direct/91d01db863ef432c8e84ad758aad6866.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

\##然后接下来的安装一定要重启ollama和控制台再下载 才能下载到改变的下载地址
...
![img](https://i-blog.csdnimg.cn/direct/f718e376c6494d79ade1bf25789da96c.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/4e086370e63f4469930da64bf6ba0abe.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/09e0f0c165684d3d9ecfbda843e85870.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

#### apifox安装

![img](https://i-blog.csdnimg.cn/direct/06d23e5aad7448c096783170b18256a6.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
Oallma支持的API可以在资料文件夹中通过《Ollama API文档.html》了解详解，双击打开查看：![img](https://i-blog.csdnimg.cn/direct/8fee4a9bc3264065bac1df062a94f574.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

通过网页可以了解到Ollama支持7个API （这里只列举了常用的），接下来我们重点先了解对话和向量化接口，因为这两个接口是最重要的，其它接口则留给大家课后自行尝试，但是在正式体验之前，需要先配置一下环境地址。

**Step 1：打开导入项目**

![img](https://i-blog.csdnimg.cn/direct/c69485665b8a4f969b51b496e01cd414.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

**Step 2：选择导入的文件**

![img](https://i-blog.csdnimg.cn/direct/055065652ab34c46be7ed19139d567a3.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

**Step 3：输入项目名称**

![img](https://i-blog.csdnimg.cn/direct/8efa34144ca74ba184708104e3c007b8.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

**Step 4：完成导入，进入项目**

![img](https://i-blog.csdnimg.cn/direct/b42f1b4062fb4a78bd62a67b5cff2164.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

#### 配置环境地址##这个地址是固定的 本地电脑ip是127.0.0.1 ollama 的端口是11434

> 本地url: http://127.0.0.1:11434



![img](https://i-blog.csdnimg.cn/direct/9ffefa8b28434be285f016811c976829.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/3df8f291b3924c2baf508dad5cd73327.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

![img](https://i-blog.csdnimg.cn/direct/25f6c570aa0544eeb1159f18240d3c81.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/7ecc1671185b49a798a24c0b6051c73a.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

图片问答需要用base64转换,以下是通过程序把图片数据转出Base64字符串的python代码,可以作为了解：
...
==注意: 斌哥已经提前生成了上面图片的Base64数据,可以在【资料/多模态测试图片Base64字符串.txt 】中找到直接使用。==

**Step 3：调用多模态接口**

在Ollama中可以通过内容生成接口和聊天对话接口来支持多模态，在此以聊天对话接口为例：

- 图片信息通过images字段传入，且可传入多张,即使传入1张也得用列表套用: ["图片字符串格式"]

- 识别的结果为引文，需要自行翻译

- 

- ![img](https://i-blog.csdnimg.cn/direct/e571d90f34fc4176a91e59ea8c08bc83.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

- ### [拓展]向量化接口

  > 本质就是把文字向量化转换

![img](https://i-blog.csdnimg.cn/direct/dee2b9f82e4f4361a876ed6d11d7f957.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

## 基于ChatBox与Ollama快速搭建聊天机器人
...
![img](https://i-blog.csdnimg.cn/direct/7cd700a3fdd94826a641866784268deb.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/edc7057b0fdb43df9d78a27a417ac426.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

**Step 2：访问ChatBox**

![img](https://i-blog.csdnimg.cn/direct/5ffc8ba602a84170b1967adbd49c4f54.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

![img](https://i-blog.csdnimg.cn/direct/493d9b22e02f4802af1c025449989f2c.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/3574afd2f7754c9f9d6c8848f4db4877.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/015c10b7e50b4ab882d7e52a7109b81d.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
![img](https://i-blog.csdnimg.cn/direct/7a5c59d88fcf4566a37e838f5bf10f37.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑

## 附件

## 网络三要素: 协议 ip地址 端口(端口号)

注意: https://www.baidu.com:443 其中[www.baidu.com](www.baidu.com)域名,百度ip地址的别名,访问流程是

1.先在本地hosts文件中,查找有没有 [www.baidu.com](www.baidu.com)对应的ip地址,如果有,就直接访问,后续不进行了

hosts文件存储位置: C:\Windows\System32\drivers\etc

![img](https://i-blog.csdnimg.cn/direct/f7dddf967c454a03934f08f129c0a45d.png)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)编辑
...
- **GET**：请求获取指定资源。 ? 直接拼接参数信息 举例: http://www.baidu.com:80/index.html?username=黑马&pwd=123
- **POST**：向服务器提交数据，通常用于表单提交。 post把重要参数信息放到请求体
- ...
...
1. [信息响应](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Reference/Status#信息响应) (`100`–`199`)
2. [成功响应](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Reference/Status#成功响应) (`200`–`299`)
